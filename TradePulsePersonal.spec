...
"""
TradePulse Personal Edition — PyInstaller Build Specification
============================================================
Compiles the standalone Windows executable for TradePulse Personal.

Key Build Specifications:
- Entry point: main_personal.py
- Embedded Assets: ui/, ui_personal/, assets/
- Target Architecture: Windows 64-bit (Console disabled, GUI mode only)
- Output Artifacts:
    1. dist/TradePulsePersonal-Standalone.exe (Single-file portable binary)
    2. dist/TradePulsePersonal/TradePulsePersonal.exe (Folder distribution bundle)
"""
import sys
...
added_files = [
    ('ui', 'ui'),                   # Shared UI components and stylesheets
    ('ui_personal', 'ui_personal'), # Dedicated Personal Edition HTML/JS interface
    ('assets', 'assets'),           # Application icons and branding assets
]
...
a = Analysis(
    ['main_personal.py'],           # Application entry script
    pathex=[],
    binaries=[],
    datas=added_files,
...
# ------------------------------------------------------------------------------
# Target 1: Single Portable Executable (dist/TradePulsePersonal-Standalone.exe)
# ------------------------------------------------------------------------------
exe_standalone = EXE(
    pyz,
    a.scripts,
    ...
    a.datas,
    [],
    name='TradePulsePersonal-Standalone',
    debug=False,
...
# ------------------------------------------------------------------------------
# Target 2: Folder Distribution Executable (dist/TradePulsePersonal/)
# ------------------------------------------------------------------------------
exe_dir = EXE(
    pyz,
    a.scripts,
