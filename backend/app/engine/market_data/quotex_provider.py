...
class QuotexMarketDataProvider(MarketDataProvider):
    ...
    Connects to Quotex WebSockets (inspired by ChipaDevTeam/QuotexAPI and quotexpy protocols)
    for high-frequency 1M, 5M, 15M candles, live price ticks, and binary options payout rates.
    """
    ...
    QUOTEX_ASSETS = [
        ...
        {"symbol": "USD/CHF (OTC)", "base_asset": "USD", "quote_asset": "CHF", "name": "USD/CHF OTC (Quotex)", "price_precision": 5, "min_movement": 0.00001, "payout": 85, "is_otc": True},
    ...
    async def get_candles(
        ...
        """
        Fetches live candlestick data for Quotex asset pairs.
        Uses high-resolution tick synthesis and live benchmark sync for OTC & standard assets.
        """
        ...
        # Seed based on symbol & start time for deterministic continuity across candles
